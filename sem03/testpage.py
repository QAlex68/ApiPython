...
class OperationsHelper(BasePage):
    ...
    def get_user_text(self):
        ...
        logging.info(f"We find text Hello, {text} on open page {TestSearchLocators.LOCATOR_HELLO}")
        return text
    ...
    def get_new_title_text(self):
        ...
        logging.info(f"We find title '{text}' on open page {TestSearchLocators.LOCATOR_SEARCH_TITLE_FIELD[1]}")
        return text
